...
def import_model(model_path, combinations_path):

    modelname = model_path # show an "Open" dialog box and return the path to the selected file
    print(modelname)

    vectorFile = combinations_path # show an "Open" dialog box and return the path to the selected file
    print(vectorFile)
